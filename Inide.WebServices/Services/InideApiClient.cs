...
{
    public class InideApiClient : IApiClient
    {
        private readonly HttpClient _httpClient;
        private readonly ILogger<InideApiClient> _logger;
        public InideApiClient(HttpClient httpClient, ILogger<InideApiClient> logger)
        {
