...
using Inide.WebServices.Protocols.Request;
using Inide.WebServices.Protocols.Response;
using Xunit;
...
namespace Inide.WebServices.Test.v1
{
    ...
    {
        private readonly Mock<IPersonService> _mockDataManager;
        ...
        public PersonsControllerTests()
        {
            ...
            _mockDataManager = new Mock<IPersonService>();
